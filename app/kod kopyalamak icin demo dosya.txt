...
export default function ProducerRequestDetailPage() {
  ...
  const suggestions = requestSuggestions[slug as string] || [];
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-[#7a5c36]">
        Bu ilana gönderilen senaryo önerilerini aşağıda görebilirsin.
      </p>

      {suggestions.length === 0 ? (
        <p className="text-sm text-[#a38d6d]">Bu ilana henüz öneri gelmemiş.</p>
      ) : (
        suggestions.map((s) => (
